...
'*************************************************************
'********************VARIABLE Selección HeChizo***************
'********************VARIABLE DE CABALLOS*********************
'*************************************************************
'************************ULISES*******************************
Public OBJETO_TIPO As Integer
Public uh As Integer
'**************************************************************
'**************************************************************
'************************ TIPOS *******************************
'**************************************************************
...
Public PassCliente As String '[Efestos] 'ULISES: Se ha de Modificar
...
Public Cielo As WorldPos
Public Infierno As WorldPos
Public Perdon As WorldPos
Public Volver As WorldPos
Public Mapnew As WorldPos
