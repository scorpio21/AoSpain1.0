...
Begin VB.Form FormAuto 
   ...
   Begin VB.Frame FrameAnim 
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "FormAuto.frx":3328
         Left            =   1680
         List            =   "FormAuto.frx":3335
         MouseIcon       =   "FormAuto.frx":334D
         MousePointer    =   99  'Custom
         TabIndex        =   60
         Text            =   "Combo2"
         Top             =   3840
      ...
      Begin VB.ComboBox ComboTipoAnim 
         Height          =   315
         ItemData        =   "FormAuto.frx":4017
         Left            =   840
         List            =   "FormAuto.frx":4021
         TabIndex        =   42
         Top             =   480
         Width           =   2295
      End
...
Private Sub Command1_Click()
    ...
    For ii = 1 To 6
        ...
        If Val(FormAuto.TextDatos(ii).Text) > MAXGrH Or Val(FormAuto.TextDatos(ii).Text) <= 0 Then
...
Private Sub Command2_Click()
    ...
    For ii = 1 To 6
        ...
        If Val(FormAuto.TextDatos2(ii).Text) > MAXGrH Or Val(FormAuto.TextDatos2(ii).Text) <= 0 Then
...
TerminarAnim:
    ...
    If CheckAuto.value = vbChecked Then ' selecionado autoindexar como...
        ...
        Select Case Combo2.listIndex
            ...
            Case 3 'Alas
                Call AgregaAlas(ii, False)
                AlaData(ii).Alas(1).GrhIndex = PrimerIndice + FramesTotales + 1
                AlaData(ii).Alas(2).GrhIndex = PrimerIndice + FramesTotales + 3
                AlaData(ii).Alas(3).GrhIndex = PrimerIndice + FramesTotales
                AlaData(ii).Alas(4).GrhIndex = PrimerIndice + FramesTotales + 2
                EstadoNoGuardado(e_EstadoIndexador.Alas) = True
            ...
            Case 5 'Botas
                ...
                BotaData(ii).Bota(1).GrhIndex = PrimerIndice + FramesTotales + 1
                BotaData(ii).Bota(2).GrhIndex = PrimerIndice + FramesTotales + 3
                BotaData(ii).Bota(3).GrhIndex = PrimerIndice + FramesTotales
                BotaData(ii).Bota(4).GrhIndex = PrimerIndice + FramesTotales + 2
...
Private Sub Command6_Click()
    ...
    For ii = 4 To 5
        ...
        If Val(FormAuto.TextDatos3(ii).Text) > MAXGrH Or Val(FormAuto.TextDatos3(ii).Text) <= 0 Then
...
Private Sub Text1_Change()
    ...
    If Val(Text1.Text > MAXGrH) Then Text1.Text = MAXGrH
...
Private Function errorEnIndice() As Boolean
    ...
    Select Case Combo2.listIndex
        ...
        Case 3 'Alas
            ...
            If Val(Text1.Text) <= UBound(AlaData) Then
                Text1.BackColor = vbWhite
            Else

                If AlaData(Val(Text1.Text)).Alas(1).GrhIndex > 0 Then
                    errorEnIndice = True
        ...
        Case 5 'botas
            ...
            If Val(Text1.Text) <= UBound(BotaData) Then
                Text1.BackColor = vbWhite
            Else

                If BotaData(Val(Text1.Text)).Bota(1).GrhIndex > 0 Then
                    errorEnIndice = True
...
Private Sub Text2_Change()
    ...
    If tempdouble1 < -MAXGrH Or tempdouble1 > MAXGrH Then
        Text2.Text = "0º" & tempdobule2
        tempdouble1 = 0

    End If

    If tempdobule2 < -MAXGrH Or tempdobule2 > MAXGrH Then
