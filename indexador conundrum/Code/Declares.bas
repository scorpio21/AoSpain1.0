...
Public ReferenciaPrincipal  As Integer

Public ReferenciaDos        As Integer

Public CarpetaDedatos       As String
...
Public UltimoindexE(e_EstadoIndexador.Grh To e_EstadoIndexador.Botas)     As Long

Public EstadoNoGuardado(e_EstadoIndexador.Grh To e_EstadoIndexador.Botas) As Boolean
...
Public Type tIndiceAlas

    Alas(1 To 4) As Integer
    HeadOffsetX As Integer
    HeadOffsetY As Integer

End Type

Public Type tIndiceAlasLong
...
Public Type tIndiceBotas

    Bota(1 To 4) As Integer
    HeadOffsetX As Integer
    HeadOffsetY As Integer

End Type

Public Type tIndiceBotasLong
