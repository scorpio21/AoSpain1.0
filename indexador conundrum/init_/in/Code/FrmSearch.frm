...
For i = 1 To MAXGrH
    If Grhdata(i).NumFrames > 0 Then
        For ii = i + 1 To MAXGrH
            ...
            If Grhdata(i).FileNum = Grhdata(ii).FileNum And Grhdata(i).NumFrames = Grhdata(ii).NumFrames And _
            Grhdata(i).sX = Grhdata(ii).sX And Grhdata(i).sY = Grhdata(ii).sY And _
            Grhdata(i).Frames(1) = Grhdata(ii).Frames(1) And Grhdata(i).Frames(2) = Grhdata(ii).Frames(2) And _
            Grhdata(i).Frames(2) = Grhdata(ii).Frames(2) Then
