...
'If InitTileEngine(frmMain.hwnd, frmMain.MainViewShp.Top + 50, frmMain.MainViewShp.Left + 4, 32, 32, PantallaX + 8, PantallaY + 20, 9) Then ' 30/05/2006
...
Do While prgRun
    ...
    If Chkflag = 3 Then
        ...
        modDirectDraw.DrawText 260, 260, "X= " & PosMouseX & " ; Y= " & PosMouseY, vbRed 'vbWhite
...
End If
frmMain.Caption = "AomAniaWorldEditor v" & App.Major & "." & App.Minor & " Build " & App.Revision & " - [" & Trabajando & "]"
